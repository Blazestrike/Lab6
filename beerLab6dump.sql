...
--
-- Table structure for table `kegcost`
--

DROP TABLE IF EXISTS `kegcost`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kegcost` (
  `beerID` int(11) NOT NULL AUTO_INCREMENT,
  `costOfKeg` varchar(25) DEFAULT NULL,
...
--
-- Dumping data for table `kegcost`
--

LOCK TABLES `kegcost` WRITE;
/*!40000 ALTER TABLE `kegcost` DISABLE KEYS */;
INSERT INTO `kegcost` VALUES (2,'155','Shangeys'),(3,'160','Gretz'),(4,'175','Origlio'),(5,'147','Bella Vista'),(6,'97','Mueller');
/*!40000 ALTER TABLE `kegcost` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-07-30  6:11:18
